			...
			<div class="table-responsive">
				...
				<table id="example1" class="table table-bordered table-striped">
					...
					<tbody>
						...
						<?php
                  $no = 1;
                  $sql = $koneksi->query("SELECT b.judul_buku, a.id_anggota, a.nama, s.tgl_kembali, s.tgl_harus_kembali
                ...
                ?>
						...
						<tr>
							...
							<td>
							<?php  $tgl = $data['tgl_harus_kembali']; echo date("d/M/Y", strtotime($tgl))?>
							</td>
						</tr>
						<?php
                  }
