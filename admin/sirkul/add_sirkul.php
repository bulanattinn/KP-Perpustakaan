<?php
// Kode untuk menghasilkan ID sirkulasi baru yang terdiri dari 9 digit
            ...
            <div class="box box-info">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="box-footer">
                        ...
                        <a href="?page=MyApp/data_sirkul" class="btn btn-warning">Batal</a>
                    </div>
                </form>
            </div>
            <!-- /.box -->
...
if (isset($_POST['Simpan'])) {
    ...
    $sql_simpan = "INSERT INTO tb_sirkulasi (id_sk, id_buku, id_anggota, tgl_pinjam, status, tgl_kembali, tgl_harus_kembali) VALUES (
        '".$_POST['id_sk']."',
        '".$_POST['id_buku']."',
        '".$_POST['id_anggota']."',
        '".$_POST['tgl_pinjam']."',
